...
Future<String> initUniLinks() async {
  ...
  try {
    ...
    if (initialLink != null) {
      appLinkUsernameReceived = initialLink.substring(initialLink.lastIndexOf('/') + 1);
        ...
        child: GestureDetector(
            ...
            child: MaterialApp(
                ...
                onGenerateInitialRoutes: (value) {
                  return [
                    AppRoute.onGenerateRoute(RouteSettings(
                        name: value, arguments: SplashScreenArgs(appLinkUsernameReceived: appLinkUsernameReceived)))!,
                  ];
                },
                ...
                theme: ThemeData(
                    ...
                    primaryTextTheme: const TextTheme(bodyMedium: AppTextTheme.bodyMedium),
